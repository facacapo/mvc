<?php 
	...
	{	
		...
		// Llama al metodo para Crear Usuario en el modelo
		public function insertUsuario(int $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, int $tipoid, int $status)
		{
		...
		//Extraer todos los  Usuarios de BD
		...
		public function updateUsuario(int $idUsuario, int $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, int $tipoid, int $status)
		{
